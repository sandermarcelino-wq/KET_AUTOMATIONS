...
// ─────────────────────────────────────────────────────────────────────────────
// Grain overlay — anima seed por frame para textura UGC
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Camera shake — determinístico por frame, simula câmera de celular
// ─────────────────────────────────────────────────────────────────────────────
      ...
      >
        <p
          style={{
            ...
            textShadow: "0 0 70px rgba(255,40,40,0.75), 0 6px 32px rgba(0,0,0,0.95)",
            opacity: mainOpacity,
...
function ProblemScene() {
  ...
  const opacity = interpolate(segFrame, [0, 5, seg - 6, seg], [0, 1, 1, 0], { extrapolateRight: "clamp" });
...
// Foto lifestyle full-bleed com Ken Burns + texto dourado
// Coloque a imagem em: public/appetix-lifestyle.jpg
// ─────────────────────────────────────────────────────────────────────────────
...
function ProductScene() {
  ...
  const lineWidth   = interpolate(frame, [26, 52], [0, 280], { extrapolateRight: "clamp" });

  return (
    <AbsoluteFill style={{ backgroundColor: "#000000", opacity: sceneOpacity }}>
      {/* Foto lifestyle — full-bleed com Ken Burns */}
      ...
      {/* Gradient escurece o rodapé para legibilidade */}
      <AbsoluteFill
        style={{
          background:
    ...
    <AbsoluteFill style={{ backgroundColor: "#0a0a0a" }}>
      ...
      >
        {BENEFITS.map((text, i) => {
          ...
          const opacity = interpolate(frame, [appearsAt, appearsAt + 8], [0, 1], { extrapolateRight: "clamp" });
          ...
          return (
            <div
              key={i}
              style={{ display: "flex", alignItems: "center", gap: 22, opacity, transform: `translateY(${y}px)` }}
            >
              <span style={{ color: "#4CAF50", fontSize: 64, lineHeight: 1, flexShrink: 0 }}>✓</span>
        ...
        <div
          style={{
            ...
            paddingLeft: 28,
            opacity: interpolate(frame, [t(2.5), t(2.8)], [0, 1], { extrapolateRight: "clamp" }),
          }}
        >
          {SUBTEXTS.map((text, i) => (
            <p
...
function CTAScene() {
  ...
  return (
    <AbsoluteFill style={{ background: "linear-gradient(180deg, #0e0005 0%, #000000 100%)" }}>
      <AbsoluteFill
        style={{
